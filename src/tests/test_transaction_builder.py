...
def test_add_ownership():
    transaction = TransactionBuilder('transfer')
    transaction.add_ownership("00501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88", [
        {
    ...
    assert transaction.data['ownerships'][0]['secret'] == bytes.fromhex('00501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88')
    assert transaction.data['ownerships'][0]['authorizedKeys'] == [{
        "publicKey": bytes.fromhex("0001b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646"),
        "encryptedSecretKey": bytes.fromhex("00501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88")
    }]


def test_add_uco_transfer():
    transaction = TransactionBuilder('transfer')
    transaction.add_uco_transfer('0000b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646', 10.03)
    assert len(transaction.data['ledger']['uco']['transfers']) == 1
    assert transaction.data['ledger']['uco']['transfers'][0]['to'] == bytes.fromhex('0000b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646')
...
def test_previous_signature_payload():
    ...
    transaction = TransactionBuilder('transfer')
    transaction.add_ownership(secret, [{
        "publicKey": "0001b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646",
        "encryptedSecretKey": '00501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88'
    }])
    transaction.add_uco_transfer('0000b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646', 0.2020)
    transaction.add_token_transfer('0000b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646', 100, '0000501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88', 1)
    transaction.set_code(code)
    transaction.set_content(content)
    transaction.add_recipient('0000501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88')
    ...
    expected_binary = (
        ...
        bytes.fromhex('0001b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646') + bytes.fromhex('00501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88') +
        ...
        bytearray([1]) +
        bytes.fromhex('0000501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88') +
        bytes.fromhex('0000b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646') +
...
def test_json():
    ...
    tx = TransactionBuilder('transfer')
    tx.add_uco_transfer('0000b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646', 0.2193)
    tx.add_ownership(bytes(bytearray([0,1,2,3,4])), [{
                     "publicKey": "0001b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646",
                     "encryptedSecretKey": '00501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88'
                     }])
    tx.build('seed', 0)
    ...
    previous_signature = crypto.sign(tx.previous_signature_payload(), transaction_keypair[0])
    ...
    assert parsed_tx['data']['ownerships'][0]['secret'] == bytearray([0, 1, 2, 3, 4]).hex()
    assert parsed_tx['data']['ledger']['uco']['transfers'][0] == {"to": "0000b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646", "amount": utils.to_big_int(0.2193)}
    assert parsed_tx['data']['ownerships'][0]['authorizedKeys'] == [{ "publicKey": "0001b1d3750edb9381c96b1a975a55b5b4e4fb37bfab104c10b0b6c9a00433ec4646", "encryptedSecretKey": "00501fa2db78bcf8ceca129e6139d7e38bf0d61eb905441056b9ebe6f1d1feaf88"}]
